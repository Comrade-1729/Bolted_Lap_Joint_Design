...
def design_lap_joint(P, w, t1, t2):
    ...
    for d in d_list:
        for GB in GB_list:
            ...
            if N_b <= 2 or N_b > 100:
                continue  # Skip if too few or too many bolts (unrealistic)
            ...
            V_dpb = IS800_2007.cl_10_3_4_bolt_bearing_capacity(
                fu_plate, bolt_fy, t1 + t2, d, e, p, 'Standard', 'FAB_SHOP'
            )
            ...
            if Utilization_ratio <= 1 and length_of_connection < min_length:
                ...
                print(f"Trying bolts: {N_b}, strength: {N_b * V_b * 0.75}, efficiency: {Utilization_ratio}")
...
if __name__ == "__main__":
    ...
    w = 120  # Plate width in mm
    t1 = 10  # Plate 1 thickness
    t2 = 10  # Plate 2 thickness
